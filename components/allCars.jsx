                ...
                {currentItems.map((el) => (
                    <div key={el.id} className='flex flex-col text-center border-2 mb-4 shadow-2xl w-[100%] gap-2 py-2'>
                        ...
                        <div className='flex font-serif justify-around'>
                            <div className='flex'>
                                <span className='text-gray-600 ml-1 text-sm sm:text-sm md:text-md lg:text-lg xl:text-lg'>{el.year}</span>
                            </div>
                 ...
                 {/* Pagination controls */}
                 <div className='flex w-max m-auto cursor-pointer text-md sm:text-md md:text-md lg:text-lg xl:text-xl mt-10 text-blue-500 rounded-xl mb-20'>
                    <button
                        className='p-2 border-blue-400 rounded-l-xl bg-blue-400 text-white'
                    ...
                    <div className='border-2 p-2 border-blue-400'>
                        Page {currentPage} of {totalPages}
                    </div>

                    <button
                        className='p-2 border-blue-400 rounded-r-xl bg-blue-400 text-white'
